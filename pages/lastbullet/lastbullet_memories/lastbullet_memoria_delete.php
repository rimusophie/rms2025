...
$page_title_text = LastbulletMemoriaCommon::PAGE_TITLE_DELETE;
...
<head>
    ...
    <title><?= LastbulletMemoriaCommon::PAGE_TITLE_DELETE ?></title>
...
try{
    ...
    LastbulletMemoriaCommon::delete($id);

    $result_msg_text = LastbulletMemoriaCommon::MESSAGE_DELETE_SUCCESS;

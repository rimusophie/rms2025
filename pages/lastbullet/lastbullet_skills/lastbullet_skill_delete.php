...
$page_title_text = LastbulletSkillCommon::PAGE_TITLE_DELETE;
...
<head>
    ...
    <title><?= LastbulletSkillCommon::PAGE_TITLE_DELETE ?></title>
...
try{
    ...
    LastbulletSkillCommon::delete($id);

    $result_msg_text = LastbulletSkillCommon::MESSAGE_DELETE_SUCCESS;

...
$page_title_text = LastbulletSkillCommon::PAGE_TITLE_LIST;
$common_link_text = LastbulletSkillCommon::PAGE_TITLE_ADD;
$common_link_href = LastbulletSkillCommon::HREF_ADD;
...
<head>
    ...
    <title><?= LastbulletSkillCommon::PAGE_TITLE_LIST ?></title>
...
<?php foreach($result as $row): ?>
                <tr>
                    ...
                    <!-- 操作 -->
                    <td>
                        <a href="<?= LastbulletSkillCommon::HREF_EDIT ?>?id=<?= urlencode($row['l_id']) ?>" class="common-link"><?= Constants::PAGE_EDIT ?></a>
                    </td>

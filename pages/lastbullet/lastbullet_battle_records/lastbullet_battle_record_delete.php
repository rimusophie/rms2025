...
$page_title_text = LastbulletBattleRecordCommon::PAGE_TITLE_DELETE;
...
<head>
    ...
    <title><?= LastbulletBattleRecordCommon::PAGE_TITLE_DELETE ?></title>
...
try{
    ...
    LastbulletBattleRecordCommon::delete($id);

    $result_msg_text = LastbulletBattleRecordCommon::MESSAGE_DELETE_SUCCESS;

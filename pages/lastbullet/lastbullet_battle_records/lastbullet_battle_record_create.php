...
try{
    LastbulletBattleRecordCommon::create($_POST[LastbulletBattleRecordCommon::HTML_NAME_BATTLE_DATE],
    ...
    $result_msg_text = LastbulletBattleRecordCommon::MESSAGE_CREATE_SUCCESS;
